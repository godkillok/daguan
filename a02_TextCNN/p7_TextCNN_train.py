...
import sys
import sys
sys.path.append('/home/tom/Desktop/text_classification-master/aa1_data_util')
...
tf.app.flags.DEFINE_string("traning_data_path","/home/tom/Desktop/text_classification-master/mafengwo.txt","path of traning data.") #O.K.train-zhihu4-only-title-all.txt-->training-data/test-zhihu4-only-title.txt--->'training-data/train-zhihu5-only-title-multilabel.txt'
tf.app.flags.DEFINE_integer("num_filters", 64, "number of filters") #256--->512
tf.app.flags.DEFINE_string("word2vec_model_path","/home/tom/Desktop/text_classification-master/fast_text.model","word2vec's vocabulary and vectors") #zhihu-word2vec.bin-100-->zhihu-word2vec-multilabel-minicount15.bin-100
    ...
    with tf.Session(config=config) as sess:
        ...
        for epoch in range(curr_epoch,FLAGS.num_epochs):
            ...
            for start, end in zip(range(0, number_of_training_data, batch_size),range(batch_size, number_of_training_data, batch_size)):
                ...
                curr_loss,curr_acc,_=sess.run([textCNN.loss_val,textCNN.accuracy,textCNN.train_op]) #curr_acc--->TextCNN.accuracy
