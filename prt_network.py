...
def pointer_net(passage, passage_len,  cell, weights_p, scope = "pointer_network"):
    '''
...
def evaluate(max_length,         # J
    ...
    with tf.device("/cpu:0"):
        ...
        with tf.variable_scope("rnn_decoder"):
            pointer_net(enc_states, passage_len, cell_dec, scope="pointer_network")
