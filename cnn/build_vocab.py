...
parser.add_argument('--min_count_word', default=5, help="Minimum count for words in the dataset", type=int)
parser.add_argument('--data_dir', default='/home/tom/new_data/input_data', help="Directory containing the dataset")
...
if __name__ == '__main__':
    ...
    words = [tok for tok, count in words.items() if count >= args.min_count_word and count<=100000]
